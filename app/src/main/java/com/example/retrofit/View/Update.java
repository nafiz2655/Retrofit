...
public class Update extends AppCompatActivity {
    ...
    private void InsertDataImage(int id, String sName, String sRoll, String sReg, String sSub, String sPhone, String sAddress, String encodedImageString) {
        ...
        helper.updatedataimage(new UpdateDataModel(id,sName,sRoll,sReg,sSub,sPhone,encodedImageString,sAddress)).enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(Update.this, "Data Update success", Toast.LENGTH_SHORT).show();
                progressbar.setVisibility(View.GONE);
            }

            @Override
            public void onFailure(Call<Void> call, Throwable throwable) {
                Toast.makeText(Update.this, "Data Update Failed", Toast.LENGTH_SHORT).show();
                progressbar.setVisibility(View.GONE);
    ...
    private void InsertData(int id, String sName, String sRoll, String sReg, String sSub, String sPhone, String sAddress, String sImage) {
        ...
        Helper helper = Service.getAPI().create(Helper.class);
        helper.updatedata(new UpdateDataModel(id,sName,sRoll,sReg,sSub,sPhone,sImage,sAddress)).enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(Update.this, "Data Update success", Toast.LENGTH_SHORT).show();
                progressbar.setVisibility(View.GONE);
